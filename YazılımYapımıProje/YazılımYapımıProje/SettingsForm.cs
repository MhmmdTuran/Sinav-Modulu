...
namespace YazılımYapımıProje
{
    public partial class SettingsForm : Form
    {
        ...
        private void TrueFalsePercentage()
        {
            ...
            float truePercentage = (Convert.ToSingle(trueCount) / Convert.ToSingle((trueCount + falseCount)) );
            float falsePercentage = (Convert.ToSingle(falseCount) / Convert.ToSingle((trueCount + falseCount)) );
